...
const AFFIX_SLOTS = {
  ...
  gloves: { prefix: 2, suffix: 2 },
  boots: { prefix: 2, suffix: 2 },
  belt: { prefix: 2, suffix: 2 },
  amulet: { prefix: 2, suffix: 2 },
  ring: { prefix: 2, suffix: 2 },
  weapon_1h: { prefix: 3, suffix: 3 },
  weapon_2h: { prefix: 3, suffix: 3 },
  offhand: { prefix: 2, suffix: 2 },
  shield: { prefix: 2, suffix: 2 },
  quiver: { prefix: 2, suffix: 2 },
  focus: { prefix: 2, suffix: 2 },
  flask: { prefix: 1, suffix: 1 },
  charm: { prefix: 0, suffix: 0 },
  jewel: { prefix: 3, suffix: 3 },
  waystone: { prefix: 3, suffix: 3 },
  tablet: { prefix: 1, suffix: 1 },
